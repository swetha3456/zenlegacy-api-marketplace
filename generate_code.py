...
def get_api_code(user_input):
    code_template = """from fastapi import FastAPI, Depends, HTTPException
...
{% endfor %}
    ...
    Generate the complete FastAPI code, including authentication and pagination. Return only code and nothing else. Ensure to use double underscores for __tablename__. Here is the code template you need to follow: {code_template}
    """
...
if __name__ == "__main__":
    print(extract_code(get_api_code("create an api for storing and retrieving employee data")))